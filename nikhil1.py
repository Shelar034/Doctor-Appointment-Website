...
class AppointmentApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.register_patient_button = tk.Button(self, text="Register Patient", command=self.open_registration_window)
        self.register_patient_button.pack()

        # Book Appointment button
        self.book_appointment_button = tk.Button(self, text="Book Appointment", command=self.open_booking_window)
...
class DoctorSelectionWindow(tk.Toplevel):
    def __init__(self, appointment_system):
        ...
        self.book_button = tk.Button(self, text="Book Appointment", command=self.book)
...
class RegistrationWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.register_button = tk.Button(self, text="Register", command=self.register_patient)
